...
<head>
    ...
    <div class="container d-flex justify-content-center align-items-center">
        <div class="w-50 box_add_value">
            <h1 class="text-center my-2">Thêm người dùng</h1>
            <form action="" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label class="form-label">Tên Tài Khoản</label>
                    <input type="text" class="form-control" name="TenTaiKhoan" value="<?= empty($_POST['TenTaiKhoan'])?"":$TenTaiKhoan?>" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="MatKhau" value="<?= empty($_POST['MatKhau'])?"":$MatKhau?>"  />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="HoTen" value="<?= empty($_POST['HoTen'])?"":$HoTen?>"  />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="DiaChi" value="<?= empty($_POST['DiaChi'])?"":$DiaChi?>"  />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="SoDienThoai" value="<?= empty($_POST['SoDienThoai'])?"":$SoDienThoai?>"  />
                </div>
