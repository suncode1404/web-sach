                    ...
                    <div class="accordion-body p-3">    
                        ...
                        <nav
                            ...
                            <ul class="pagination gap-3">
                                ...
                                <a class="page-link text-dark" href="?mod=book&act=search&keyword=<?=$_GET['keyword']?>&page=<?=$page-1?>"
                                    ><svg
                                ...
                                <?php for($i=1;$i<=$sotrang;$i++):?>
                                    ...
                                    <a class="page-link" href="?mod=book&act=search&keyword=<?=$_GET['keyword']?>&page=<?=$i?>"><?=$i?></a>
                                    </li>
                                <?php endfor;?>   
