      ...
      <header id="header">
         ...
         <nav class="navbar navbar-expand-lg">
            <div class="container container_nav_logo">
               ...
               <div class="collapse navbar-collapse w-75 justify-content-between" id="navbarSupportedContent">
                  <div class="input-group w-50 justify-content-center">
                     <input type="search" class="form-control rounded w-25" placeholder="Nhập tên sach, tác giả, tuyển tập,..." aria-label="Search" aria-describedby="search-addon" />
                     <button type="button" class="btn btn-outline-light bg-success fs-6 d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-search me-2" viewBox="0 0 16 16">
                           <path
                  ...
                  <ul class="navbar-nav mb-2 mb-lg-0 w-auto gap-3">
                     <li class="nav-item bg-danger rounded p-1 fs-6">
                        <a class="nav-link text-light fw-medium d-flex flex-column align-items-center link_service" aria-current="page" href="#">
                           <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-cart mb-1" viewBox="0 0 16 16">
                              <path
                     ...
                     <li class="nav-item bg-warning rounded p-1">
                        <a class="nav-link text-light fw-medium d-flex flex-column align-items-center link_service" href="#">
                           <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-bell mb-1" viewBox="0 0 16 16">
                              <path
                     ...
                     <li class="nav-item bg-success rounded p-1">
                        <a class="nav-link fw-medium text-light d-flex flex-column align-items-center link_service" href="#">
                           <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-person mb-1" viewBox="0 0 16 16">
                              <path
         ...
         <nav class="navbar navbar-expand-lg">
            <div class="container">
               <div class="collapse navbar-collapse d-flex justify-content-center me-4" id="navbarSupportedContent">
                  <ul class="navbar-nav mb-lg-0 d-flex align-items-center gap-4">
                     ...
                     <li class="nav-item">
                        <a class="nav-link fs-5 link-offset-5" href="#"> Sách trong nước </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link fs-5 link-offset-5" href="#"> Sách ngoài nước </a>
                     </li>
                  </ul>
               </div>
            </div>
