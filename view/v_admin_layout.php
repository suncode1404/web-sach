...
<html lang="en">
   ...
   <body class="">
      <div class="container">
                  ...
                  <div class="b-boxsv">
                     <div class="user-service">
                        ...
                        <div class="btn-service">
                           ...
                           <button>
                              <a href="?mod=admin&act=dashboard" style="color:#fff;">
                              <svg
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="20"
                                 height="20"
                     ...
                     <div class="list-service">
                        <nav class="nav-item">
                           <ul class="list-item">
                              <li class="item-main">
                                 <a href="?mod=admin&act=user" class="link-item">
                                    <svg
                                       xmlns="http://www.w3.org/2000/svg"
                                       width="25"
                                       height="25"
                              ...
                              <li class="item-main">
                                 <a href="?mod=admin&act=product" class="link-item">
                                    <svg
                                       xmlns="http://www.w3.org/2000/svg"
                                       width="25"
                                       height="25"
         ...
         <a href="?mod=page&act=home" class="box-btn">
            Đăng xuất
            <svg
               xmlns="http://www.w3.org/2000/svg"
               width="32"
